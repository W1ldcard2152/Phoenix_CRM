 ...
 */
const DATE_START_FIELDS = new Set(['effectiveFrom', 'oneTimeDate', 'dueDate', 'date', 'invoiceDate']);
const DATE_END_FIELDS = new Set(['effectiveUntil', 'registrationExpiration', 'inspectionExpiration']);
