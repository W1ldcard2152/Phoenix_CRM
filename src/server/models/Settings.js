...
const SettingsSchema = new Schema(
  {
    ...
    // invoices/quotes. Deliberately blank: every deployment is a different shop,
    // and a default here prints someone else's business on a new tenant's
    // invoices. Set per tenant by scripts/provision-tenant.js, or in Settings.
    ...
    // Stable same-origin URL used by the header and PDF generation. Empty until a
    // logo is uploaded to S3, then /api/settings/company-logo (see companyLogoKey).
